...
const CAT_ICONS: [string[], string][] = [
  ...
  [['saltado', 'salteado', 'stir', 'fry'],  'M8 14c-3 0-5-2-5-5 0-2 1-4 2-5 0 2 1 3 2 3.5-.5-2 0-3.5 1-4.5 0 2 2 4 2 6 .5-1 .5-2 0-3 1.5 1.5 1 4-.5 5.5 1-.5 1.5-2 1.5-2.5'],
  [['soup', 'sopa', 'caldo'],               'M3 10h10M2 13h12l-.8 2H2.8L2 13zM6 7c0-1.5 1-2 1-3M10 7c0-1.5-1-2-1-3'],
  [['criollo', 'criolla'],                  'M8 1.5l1.6 4.5H15l-4 2.8 1.5 4.7L8 10.5l-4.5 3 1.5-4.7-4-2.8h5.4z'],
  ...
  [['drink', 'bebida', 'jugo', 'chicha'],   'M5 2h6l-1 11H6L5 2zM4 5h8'],
